...
void SelectShader(var shaderNumber)
{
    ...
    if(shaderNumber ==   7)
    {
        #include "_SHADERS/radial_OCC_blur/radial_OCC_blur_SHADER_RENDER.cpp"
    }    
    //--------------------------------------------------------------------------------------    
...
*/
    ...
    //============================================================     
    scaleFrameBufferPlaneViewPort = scale_generic_FBO;
    #include "_SHADERS/radial_OCC_blur/radial_OCC_blur_RENDER.cpp"
    //============================================================
    //=======================_RADIAL_OCC_BLUR_====================
...
configureShader = 1;
    ...
    {
            adjustShadow_PosRadial_OCC[0]             +=   0.00001;
    }
    ...
    if(keys[VK_F8] && !keys[VK_SHIFT] && !keys[VK_CONTROL])
    {
         ...
         //------------------------------------------------------------------------------------------------------------------------------
         outSettings << "var          adjustShadow_PosRadial_OCC[]      =  {"    
                                  <<  adjustShadow_PosRadial_OCC[0]      << ", "   
                                  <<  adjustShadow_PosRadial_OCC[1]      << "};\n\n";      
         //------------------------------------------------------------------------------------------------------------------------------
